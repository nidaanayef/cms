...
@section("title", " Realestate Categories - Recycle Bin ")
        ...
        <table class="table table-bordered table-striped table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-right">           
                        <a class="btn btn-sm confirm btn-warning" href='{{ route("photo-category.restore", ["id" => $item->id]) }}'><i class='fa fa-redo'></i> Recovery</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
